SIZE = 400                      # screen size - 400 * 400
GRID_LEN = 4                    # 4 * 4   
GRID_PADDING = 10               # padding is the space betweeen cells

BACKGROUND_COLOR_GAME = "#92877d"
BACKGROUND_COLOR_CELL_EMPTY = "#9e948a"      # background colour of blog with zero entry

# background colour corresponding to the values of a cell
BACKGROUND_COLOR_DICT = {2: "#eee4da", 4: "#ede0c8", 8: "#f2b179",
                         16: "#f59563", 32: "#f67c5f", 64: "#f6503b",
...
# colour of the text of numbers in a cell
